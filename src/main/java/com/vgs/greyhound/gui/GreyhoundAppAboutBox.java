...
public class GreyhoundAppAboutBox extends javax.swing.JDialog {

    public GreyhoundAppAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.vgs.greyhound.gui.GreyhoundApp.class).getContext().getResourceMap(GreyhoundAppAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.vgs.greyhound.gui.GreyhoundApp.class).getContext().getActionMap(GreyhoundAppAboutBox.class, this);
